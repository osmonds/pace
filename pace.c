...
const zend_function_entry pace_functions[] = {
	PHP_FE(confirm_pace_compiled,	NULL)		/* For testing, remove later. */
...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("pace.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_pace_globals, pace_globals)
    STD_PHP_INI_ENTRY("pace.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_pace_globals, pace_globals)
PHP_INI_END()
*/
/* }}} */
...
PHP_MINFO_FUNCTION(pace)
{
	...
	php_info_print_table_header(2, "pace support", "enabled");
